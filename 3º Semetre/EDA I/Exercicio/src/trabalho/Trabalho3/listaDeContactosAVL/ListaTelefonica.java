...
public class ListaTelefonica {
    ...
    AvlTree<Contacto> lista = new AvlTree<>();
    int size = 0;
    ...
    public static void main(String[] args) {
        ...
        telf.insertContact("ze", 123);
        telf.insertContact("Ana", 456);
        telf.insertContact("Anabela", 678);
        telf.insertContact("Rodrigo", 9012);
        //telf.editar("ze");
        System.out.println(telf.chamador(123));

        //telf.editar("Ana");
        System.out.println(telf.chamador(61230));
        telf.removeContact(9012);
