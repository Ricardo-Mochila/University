...
class Game:
    ...
    def random_player(self, px):
        ...
        if px == 0:
            player_score = self.player_one_score
        elif px == 1:
            player_score = self.player_two_score

        for i in range(0, 6):
            self.change_table(px, i)
            if px == 0:
                if player_score < self.player_one_score:
                    self.player_one_score = player_score
                    posy = i

            elif px == 1:
                if player_score < self.player_two_score:
    ...
    def play_alpha_beta(self):
        while True:
            ...
            if result != 'AO' and result != 'AX' and result != 'T' and result != None:
                if result == 'X':
                    print('The winner is the Player!')
                elif result == 'O':
                    print('The winner is Min-Max!')
                elif result == 'Tied':
                    print("It's a tie!")
            ...
            if self.player_turn == 'A':
                ...
                py = self.random_player(0)                
                
                self.change_table(0, py)
                print("Random played in: ", py+1)   
